...
local opencxl_d2h_req_header = Proto("opencxl.cache.d2h.req","CXL.cache D2H_REQ Header")
local opencxl_d2h_rsp_header = Proto("opencxl.cache.d2h.rsp","CXL.cache D2H_RSP Header")
local opencxl_d2h_data_header = Proto("opencxl.cache.d2h.data","CXL.cache D2H_DATA Header")
local opencxl_h2d_req_header = Proto("opencxl.cache.h2d.req","CXL.cache H2D_REQ Header")
local opencxl_h2d_rsp_header = Proto("opencxl.cache.h2d.rsp","CXL.cache H2D_RSP Header")
local opencxl_h2d_data_header = Proto("opencxl.cache.h2d.data","CXL.cache H2D_DATA Header")
...
local mem_m2s_birsp_header_mem_opcode = ProtoField.new   ("Opcode", "opencxl.mem.m2s.birsp.mem_opcode", ftypes.UINT32, mem_header_m2s_birsp_opcode_readable, base.HEX, 0x1E, "Opcode")
